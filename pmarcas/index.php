    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Marcas
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-create1">
                    ...
                    <div class="card card-outline  card-primary">
                        ...
                        <div class="card-body" style="display: block;">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <?php
                                $contador=0;
                                foreach ($pmarcas_datos as $pmarcas_dato) {
                                    $id_marca =$pmarcas_dato['id_marca'];
                                    $nombre =$pmarcas_dato['nombre'];
                                    $nro_contacto =$pmarcas_dato ['nro_contacto'];
                                    ?>
                                    <tr>
                                        <td><center> <?php echo $contador=$contador+1;?></center></td>
                                        <td><?php echo $pmarcas_dato['nombre'];?></td>
                                        <td><?php echo $pmarcas_dato['nro_contacto'];?></td>
                                        <td>
                                            <center>
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-success" data-toggle="modal"
                                                            data-target="#modal-update1<?php echo $id_marca;?>">
                                                        <i class="fa fa-pencil-alt"></i> Editar
                                                    </button>
                                                    <!-- /.Modal para modificar marca -->
                                                    <div class="modal fade" id="modal-update1<?php echo $id_marca; ?>">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer justify-content-between">
                                                                    ...
                                                                    <button type="button" class="btn btn-success" id="btn_update1<?php echo $id_marca;?>">Actualizar</button>
                                                                </div>
                                                            </div>
                                                            <!-- /.modal-content -->
                                                        </div>
...
<div class="modal fade" id="modal-create1" >
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                <button type="button" class="btn btn-primary" id="btn_create1">Registrar</button>
...
<script>
    $('#btn_create1').click(function () {
        ...
        var url = "../app/controllers/pmarcas/registro_de_marcas.php";
